...
export default function Home() {
  ...
  const featuredCourses = catalogCourses.slice(0, 3);
  
  const totalLessons = catalogCourses.reduce((acc, c) => acc + c.lessonCount, 0);
  ...
  const resumeHref = catalogCourses[0]?.id && catalogCourses[0].id.length > 0 ? `/course/${catalogCourses[0].id}` : '/subject/mathematics';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-4">
              ...
              <Link href="/marketplace" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium transition-colors flex items-center gap-1">
              ...
              <div ref={progressRef} className="relative">
                ...
                {progressDropdownOpen && (
                  <div className="absolute top-full left-0 mt-2 w-48 bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-800 py-2 z-50">
                    <Link href="/achievements" className="flex items-center gap-2 px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800">
                      <Gift className="w-4 h-4" /> Achievements
                    </Link>
              ...
              <div ref={learnRef} className="relative">
                ...
                {learnDropdownOpen && (
                  <div className="absolute top-full left-0 mt-2 w-48 bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-800 py-2 z-50">
                    ...
                    <Link href="/flashcards" className="flex items-center gap-2 px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800">
                     ...
                     <Link href="/teacher/courses" className="flex items-center gap-2 px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800">
              ...
              {isSignedIn ? (
                ...
                <div className="flex items-center gap-2">
                  <Link href="/sign-in" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium transition-colors">
                    Sign In
                  </Link>
                  <Link href="/sign-up" className="bg-gray-900 hover:bg-gray-800 text-white px-4 py-2 rounded-lg font-medium transition-colors">
                    Get Started
                  </Link>
                </div>
              )}
        ...
        {mobileMenuOpen && (
          <div id="mobile-menu" className="md:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-4 px-4">
            <nav className="flex flex-col gap-4" role="menu">
              <Link href="/tutor" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <Bot className="w-4 h-4" /> AI Tutor
              </Link>
              <Link href="/marketplace" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <Users className="w-4 h-4" /> Marketplace
              </Link>
              <Link href="/leaderboard" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <Trophy className="w-4 h-4" /> Leaderboard
              </Link>
              <Link href="/competition" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <Award className="w-4 h-4" /> Competition
              </Link>
              <Link href="/achievements" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <Gift className="w-4 h-4" /> Achievements
              </Link>
              <Link href="/report" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <FileText className="w-4 h-4" /> Report Card
              </Link>
              <Link href="/analytics" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <BarChart3 className="w-4 h-4" /> Analytics
              </Link>
              <Link href="/search" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <Search className="w-4 h-4" /> Search
              </Link>
              <Link href="/notes" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <BookOpen className="w-4 h-4" /> Notes
              </Link>
              <Link href="/flashcards" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <BrainCircuit className="w-4 h-4" /> Flashcards
              </Link>
              <Link href="/calendar" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <CalendarDays className="w-4 h-4" /> Calendar
              </Link>
              <Link href="/bookmarks" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                <Bookmark className="w-4 h-4" /> Bookmarks
              </Link>
               <Link href="/settings" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                 <Settings className="w-4 h-4" /> Settings
               </Link>
               <Link href="/teacher/courses" role="menuitem" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium flex items-center gap-2 py-2">
                 <GraduationCap className="w-4 h-4" /> Teacher
               </Link>
             </nav>
          </div>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-purple-600 py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              ...
              <a href={resumeHref} className="bg-white text-blue-600 px-6 py-2 rounded-lg font-medium hover:bg-blue-50 transition-colors">
                Resume →
              </a>
            </div>
          </div>
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              {isSignedIn ? (
                ...
                <Link href="/sign-up" className="bg-white text-gray-900 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-colors flex items-center gap-2">
                  Start Learning
                  <ChevronRight className="w-5 h-5" />
                </Link>
              )}
      ...
      <section id="subjects" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-12">
            ...
            {catalogError && <span className="text-sm text-red-600">{catalogError}</span>}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {catalogLoading && catalogSubjects.length === 0 && (
              <div className="col-span-full text-center text-sm text-gray-500">Loading subjects...</div>
            )}
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link href="/search" className="text-blue-600 font-medium hover:text-blue-700 flex items-center gap-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">&ldquo;The AI tutor helped me understand calculus concepts I was struggling with for weeks. My marks improved significantly!&rdquo;</p>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">&ldquo;Instead of watching hours of videos, I focus only on the must-watch ones. Saved me so much time during exams!&rdquo;</p>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">&ldquo;The spaced repetition system keeps me on track. I actually remember what I learned instead of forgetting it!&rdquo;</p>
